...
# )
# 
# file.remove("data/mean_under_5_vaccination_6mo_immunity.parquet")
# 
# write_parquet(mean_averted_under5_vaccination_6mo_immunity, "data/mean_averted_under5_vaccination_6mo_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_over65_vaccination_6mo_immunity.parquet")
# 
# write_parquet(mean_averted_over65_vaccination_6mo_immunity, "data/mean_averted_over65_vaccination_6mo_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under5_over65_vaccination_6mo_immunity.parquet")
# file.remove("data/mean_no_vaccination_6mo_immunity.parquet")
# 
# write_parquet(mean_averted_under5_over65_vaccination_6mo_immunity, "data/mean_averted_under5_over65_vaccination_6mo_immunity.parquet")
# 
...
# )
# 
# write_parquet(mean_total_mean_no_vaccination_9yr_immunity, "data/mean_total_mean_no_vaccination_9yr_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under_5_vaccination_9yr_immunity.parquet")
# 
# write_parquet(mean_averted_under5_vaccination_9yr_immunity, "data/mean_averted_under5_vaccination_9yr_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_over65_vaccination_9yr_immunity.parquet")
# 
# write_parquet(mean_averted_over65_vaccination_9yr_immunity, "data/mean_averted_over65_vaccination_9yr_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under5_over65_vaccination_9yr_immunity.parquet")
# file.remove("data/mean_no_vaccination_9yr_immunity.parquet")
# 
# write_parquet(mean_averted_under5_over65_vaccination_9yr_immunity, "data/mean_averted_under5_over65_vaccination_9yr_immunity.parquet")
# 
...
# )
# 
# write_parquet(mean_total_mean_no_vaccination_2yr_immunity, "data/mean_total_mean_no_vaccination_2yr_immunity.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under_5_vaccination_30_VE.parquet")
# 
# write_parquet(mean_averted_under5_vaccination_30_VE, "data/mean_averted_under5_vaccination_30_VE.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_over65_vaccination_30_VE.parquet")
# 
# write_parquet(mean_averted_over65_vaccination_30_VE, "data/mean_averted_over65_vaccination_30_VE.parquet")
# 
# ####
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under5_over65_vaccination_30_VE.parquet")
# 
# write_parquet(mean_averted_under5_over65_vaccination_30_VE, "data/mean_averted_under5_over65_vaccination_30_VE.parquet")
# 
...
# )
# 
# file.remove("data/mean_under_5_vaccination_90_VE.parquet")
# 
# write_parquet(mean_averted_under5_vaccination_90_VE, "data/mean_averted_under5_vaccination_90_VE.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_over65_vaccination_90_VE.parquet")
# 
# write_parquet(mean_averted_over65_vaccination_90_VE, "data/mean_averted_over65_vaccination_90_VE.parquet")
# 
# ###
# 
# run_and_save_scenario(
...
# )
# 
# file.remove("data/mean_under5_over65_vaccination_90_VE.parquet")
